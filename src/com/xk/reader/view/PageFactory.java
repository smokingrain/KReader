...
import com.xk.reader.utils.ScreenUtils;
...
//        LogUtils.i("charset=" + charset);
     ...
     * @param canvas
     */
    public synchronized void onDrawPage(Canvas canvas) {
    	System.out.println("onDrawPage1");
        if (mLines.size() == 0) {
        ...
        if (mLines.size() > 0) {
            ...
            System.out.println("onDrawPage4");
            // 绘制提示内容
            ...
            System.out.println("onDrawPage5");
        }
    }
