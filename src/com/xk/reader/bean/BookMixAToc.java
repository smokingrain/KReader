...
import com.xk.reader.bean.base.Base;
...
public class BookMixAToc extends Base {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 264275086728889545L;
	/**
    ...
    public static class mixToc implements Serializable {
        ...
        public static class Chapters implements Serializable {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -1448554055311825243L;
			public String title;
            public String link;
            public String id;
            public int currency;
